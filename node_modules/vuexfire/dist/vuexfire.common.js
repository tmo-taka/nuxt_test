...
function firebaseAction(action) {
    return function firebaseEnhancedActionFn(context, payload) {
        ...
        return action.call(this, __assign({}, context, { bindFirebaseRef: function (key, ref, options) { return bind(state, commit, key, ref, ops, Object.assign({}, DEFAULT_OPTIONS, options)); }, unbindFirebaseRef: function (key, reset) {
...
function firestoreAction(action) {
    return function firestoreEnhancedActionFn(context, payload) {
        ...
        return action.call(this, __assign({}, context, { bindFirestoreRef: function (key, ref, options) {
